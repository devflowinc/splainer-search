...
(function() {
  angular.module('o19s.splainer-search')
    .factory('TrieveSearcherFactory', [
      '$q',
      '$log',
      'TrieveDocFactory',
      'activeQueries',
      'trieveSearcherPreprocessorSvc',
      'trieveUrlSvc',
      'SearcherFactory',
      'transportSvc',
  ...
  function TrieveSearcherFactory(
    $q, $log,
    TrieveDocFactory,
    activeQueries,
    trieveSearcherPreprocessorSvc,
    ...
    var Searcher = function(options) {
      SearcherFactory.call(this, options, trieveSearcherPreprocessorSvc);
    };
    ...
    function addDocToGroup (groupedBy, group, trieveDoc) {
    ...
    function search () {
      ...
      const headers = trieveUrlSvc.getHeaders(self.config.customHeaders);
      ...
      return transport.query(url, queryDslWithPagerArgs, headers)
        .then(function success(httpConfig) {
          ...
          var parseDoc = function(doc, groupedBy, group) {
            ...
            return new TrieveDocFactory(doc, options);
          };
          ...
          activeQueries.count--;
          self.inError = true;
          msg.searchError = 'Error with Trieve query or server. Review request manually.';
          return $q.reject(msg);
        })
